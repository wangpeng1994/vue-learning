...
var appTodo = new _vue2.default({
  ...
  created: function created() {
    ...
    window.onbeforeunload = function () {
      ...
      var unCommitedString = JSON.stringify(_this.newTodo);
    ...
    var oldUnCommitedString = window.localStorage.getItem('unCommited');
    var oldUnCommited = JSON.parse(oldUnCommitedString);
